...
def run():
  ...
  x.padding_width = 1
  x.add_row(['Jan 23th', '%-.2f' % predictions[0], prediction_dataset[0], '%-.2f' % (abs((prediction_dataset[0]-predictions[0]) / (prediction_dataset[0])) * 100)])
  x.add_row(['Jan 24th', '%-.2f' % predictions[1], prediction_dataset[1], '%-.2f' % (abs((prediction_dataset[1]-predictions[1]) / (prediction_dataset[1])) * 100)])
  x.add_row(['Jan 25th', '%-.2f' % predictions[2], prediction_dataset[2], '%-.2f' % (abs((prediction_dataset[2]-predictions[2]) / (predictions[2] + prediction_dataset[2])) * 100)])
  x.add_row(['Jan 26th', '%-.2f' % predictions[3], prediction_dataset[3], '%-.2f' % (abs((prediction_dataset[3]-predictions[3]) / (prediction_dataset[3])) * 100)])
  x.add_row(['Jan 27th', '%-.2f' % predictions[4], prediction_dataset[4], '%-.2f' % (abs((prediction_dataset[4]-predictions[4]) / (prediction_dataset[4])) * 100)])
  x.add_row(['Jan 28th', '%-.2f' % predictions[5], prediction_dataset[5], '%-.2f' % (abs((prediction_dataset[5]-predictions[5]) / (prediction_dataset[5])) * 100)])
  x.add_row(['Jan 30th', '%-.2f' % predictions[6], prediction_dataset[6], '%-.2f' % (abs((prediction_dataset[6]-predictions[6]) / (prediction_dataset[6])) * 100)])
  x.add_row(['Jan 31th', '%-.2f' % predictions[7], prediction_dataset[7], '%-.2f' % (abs((prediction_dataset[7]-predictions[7]) / (prediction_dataset[7])) * 100)])
  x.add_row(['feb 1th', '%-.2f' % predictions[8], prediction_dataset[8], '%-.2f' % (abs((prediction_dataset[8]-predictions[8]) / (prediction_dataset[8])) * 100)])
  x.add_row(['fec 2nd', '%-.2f' % predictions[9], prediction_dataset[9], '%-.2f' % (abs((prediction_dataset[9]-predictions[9]) / (prediction_dataset[9])) * 100)])
  x.add_row(['jan 3rd-', '%-.2f' % predictions[10], prediction_dataset[10], '%-.2f' % (abs((predictions[10]-prediction_dataset[10]) / (prediction_dataset[10])) * 100)])
  x.add_row(['Jan 04th', '%-.2f' % predictions[11], prediction_dataset[11], '%-.2f' % (abs((prediction_dataset[11]-predictions[11]) / (prediction_dataset[11])) * 100)])
  x.add_row(['Jan 6th', '%-.2f' % predictions[12], prediction_dataset[12], '%-.2f' % (abs((prediction_dataset[12]-predictions[12]) / (prediction_dataset[12])) * 100)])
  x.add_row(['Jan 9thth', '%-.2f' % predictions[13], prediction_dataset[13], '%-.2f' % (abs((prediction_dataset[13]-predictions[13]) / (prediction_dataset[13])) * 100)])
  print x
